...
// Generate browser-related meta tags
export const generateBrowserMeta = () => {
  return {
...
// Generate browser-related link tags
export const generateBrowserLinks = () => {
  return [
...
// Generate browser-related schema
export const generateBrowserSchema = () => {
  return {
...
// Generate browser-related meta tags for calculator pages
export const generateCalculatorBrowserMeta = ({
  name,
  description
}) => {
  return {
